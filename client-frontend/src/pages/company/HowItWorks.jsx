        ...
        <div className="max-w-7xl mx-auto">
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
              <ScrollReveal direction="left" delay={0.1} className="flex-1 order-2 md:order-1 relative group">
              ...
              <ScrollReveal direction="right" delay={0.2} className="flex-1 order-1 md:order-2 flex flex-col gap-6">
            ...
            {/* Step 2 */}
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24">
              <ScrollReveal direction="left" delay={0.1} className="flex-1 flex flex-col gap-6">
              ...
              <ScrollReveal direction="right" delay={0.2} className="flex-1 relative group">
